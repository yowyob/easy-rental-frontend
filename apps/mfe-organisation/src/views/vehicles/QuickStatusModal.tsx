...
export const QuickStatusModal = ({ vehicle, onSubmit, onClose, modalLoading, error }: any) => {
          ...
          <div className="p-10 space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-black text-slate-400 italic tracking-widest flex items-center gap-2">
                <AlertTriangle size={14} /> État de disponibilité immédiat
              </label>
              ...
              {isMaintenance ? (
                <>
                  <label className="text-[10px] font-black text-orange-600 italic tracking-widest flex items-center gap-2">
                    <CalendarRange size={16} /> Durée de maintenance (obligatoire) *
                  </label>
                  ...
                  <input
                    required
                    placeholder="Motif (ex: Révision moteur, carrosserie...)"
                ...
                <>
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <span className="text-[10px] font-black text-[#0528d6] italic tracking-widest flex items-center gap-2">
                      <CalendarRange size={16} /> Planifier une indisponibilité
                    </span>
                  </label>
                  {formData.addSchedule && (
                    <>
                      ...
                      <input
                        placeholder="Raison technique (ex: Révision moteur)..."
                        value={formData.schedule.reason}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
