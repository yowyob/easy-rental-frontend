    ...
    <div className="space-y-1.5 group w-full text-left">
      ...
      <div className="relative group">
        ...
        <input
          ...
          className={`w-full bg-slate-50 dark:bg-slate-900 border-2 border-slate-100 dark:border-slate-800 rounded-xl pl-12 ${isPassword ? 'pr-12' : 'pr-4'} py-3.5 text-sm font-bold text-slate-700 dark:text-white outline-none focus:bg-white dark:focus:bg-[#0f1323] focus:border-[#0528d6] transition-all shadow-sm`}
        />
        {isPassword && (
          <button
            type="button"
